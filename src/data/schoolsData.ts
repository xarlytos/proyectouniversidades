...
// Función para obtener la escuela de una titulación
export const getSchoolForTitulation = (universidad: string, titulacion: string): string | null => {
  ...
  if (!universitySchools) return null;
...
// Función para obtener todas las escuelas de una universidad en orden
export const getSchoolsForUniversity = (universidad: string): string[] => {
  return schoolOrder[universidad as keyof typeof schoolOrder] || [];
};
