...
import { Users, BarChart3, Settings, LogOut, Shield, User, UserCog } from 'lucide-react';
import { User as UserType } from '../types/auth';

interface SidebarProps {
  currentPage: 'contactos' | 'conteo' | 'usuarios' | 'admin';
  onPageChange: (page: 'contactos' | 'conteo' | 'usuarios' | 'admin') => void;
  user: UserType | null;
  onLogout: () => void;
}
